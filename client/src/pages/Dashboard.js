      ...
      <main className="flex-1 p-10">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">Need something? Post a request and let shoppers help you out.</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded shadow p-6">
          ...
          <div className="flex flex-col items-center justify-center text-gray-400 py-10">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v4a1 1 0 001 1h3m10-5h3a1 1 0 011 1v4a1 1 0 01-1 1h-3m-6 4v4a1 1 0 001 1h2a1 1 0 001-1v-4m-6 4h6" />
            </svg>
