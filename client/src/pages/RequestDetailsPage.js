...
const RequestDetailsPage = () => {
  ...
  const handleAccept = async () => {
    try {
      ...
      let requesterId = '';
      if (reqDoc.exists()) requesterId = reqDoc.data().requesterId;
      ...
      <main className="flex-1 p-10 flex gap-8">
        ...
        <div className="flex-1 max-w-2xl">
          ...
          <div className="bg-white rounded shadow p-6 mb-6">
            ...
            {/* Rating section — works for BOTH requester and shopper */}
            {showRating && !hasRated && (
              <div className="mt-8" id="rate">
                <h3 className="text-lg font-semibold mb-2 flex items-center">
                  ...
                  {user.uid === request.requesterId ? 'Rate the Shopper' : 'Rate the Requester'}
                </h3>
                <RatingForm
